...
- 1.4.1【推荐】始终使用大括号包裹代码块。`eslint`: [curly](https://eslint.org/docs/rules/curly) [nonblock-statement-body-position](https://eslint.style/rules/nonblock-statement-body-position)
...
- 2.2.5.1.【强制】字符串优先使用单引号。`eslint`: [quotes](https://eslint.style/rules/quotes)
...
- 2.2.5.3.【强制】禁止不必要的转义字符。`eslint`: [no-useless-escape](https://eslint.org/docs/rules/no-useless-escape)
...
- 2.4.1.【强制】不允许在没有参数的情况下调用Object构造函数。`eslint`: [no-object-constructor](https://eslint.org/docs/rules/no-object-constructor)
...
- 2.4.4.【强制】对象的属性名不要用引号包裹，除非包含特殊字符。`eslint`: [quote-props](https://eslint.style/rules/quote-props)
...
- 2.5.5.【推荐】箭头函数编码风格。`eslint`: [arrow-parens](https://eslint.style/rules/arrow-parens) [arrow-body-style](https://eslint.style/rules/arrow-body-style)
...
- 2.5.11.【强制】将立即执行函数表达式（`IIFE`）用小括号包裹。`eslint`: [wrap-iife](https://eslint.style/rules/wrap-iife)
...
- 2.7.1.【推荐】使用 `ES6 modules` 而非其他非标准的模块系统。`eslint`: [import/module-systems](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/module-systems.md)
...
- 2.7.2.【强制】不要用多个 `import` 引入同一模块。`eslint`: [import/no-duplicates](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/no-duplicates.md)
...
- 2.7.3.【强制】import 语句需要放到模块的最上方。`eslint`: [import/first](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/first.md)
...
- 2.7.4.【强制】禁止 `default import` 的名字跟文件内的其他 `export` 命名相同。`eslint`: [import/no-named-as-default](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/no-named-as-default.md)
...
- 2.7.5.【强制】禁止引用自身。`eslint`: [import/no-self-import](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/no-self-import.md)

- 2.7.6.【强制】禁止循环引用。`eslint`: [import/no-cycle](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/no-cycle.md)

- 2.7.7.【推荐】不要在 default export 上使用一个已导出的名称作为属性。`eslint`: [import/no-named-as-default-member](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/no-named-as-default-member.md)
...
- 2.7.8.【推荐】在模块导入之后保留一个空行。`eslint`: [import/newline-after-import](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/newline-after-import.md)
...
- 2.7.9.【参考】import 语句的排序。`eslint`: [import/order](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/order.md)
...
- 2.7.10.【参考】当模块内只有一个 `export` 时，使用 `default export`。`eslint`: [import/prefer-default-export](https://github.com/import-js/eslint-plugin-import/blob/HEAD/docs/rules/prefer-default-export.md)
...
- 2.8.6.【强制】混合使用多种操作符时，用小括号包裹分组。`eslint`: [no-mixed-operators](https://eslint.style/rules/no-mixed-operators)
...
- 3.3.【强制】注释内容和注释符之间需要有一个空格。stylistic: [spaced-comment](https://eslint.style/rules/spaced-comment)
